...
$rent_hero_banners = get_field('rent_hero_banners');
?>
				...
				<div class="swiper-slide list-item">
					<div class="slide-item">
						<a class="img-ratio ratio:pt-[800_1920] xl:ratio:pt-[600_1920]" href="javascript:void(0)">
							<img class="lozad" data-src="<?php echo esc_url($normal_image['url']); ?>"
								alt="<?php echo esc_attr($normal_image['alt'] ?: 'Banner'); ?>">
						</a>
					</div>
				</div>
				<?php 	
				...
				<div class="swiper-slide list-item">
					<div class="slide-item">
						<div class="slide-bg">
							<a class="img-ratio ratio:pt-[800_1920] xl:ratio:pt-[600_1920]" href="javascript:void(0)">
								<?php if ( $rent_hero_bg ) : ?>
								<img class="lozad" data-src="<?php echo esc_url($rent_hero_bg['url']); ?>"
									alt="<?php echo esc_attr($rent_hero_bg['alt'] ?: 'Background'); ?>" />
								<?php else : ?>
								<img class="lozad"
									data-src="<?php echo get_template_directory_uri(); ?>/img/bg_banner_2.png"
									alt="Background" />
								<?php endif; ?>
							</a>
							<div class="slide-overlay"></div>
							<img class="layer-union" src="<?php echo get_template_directory_uri(); ?>/img/Union.svg"
								alt="Decoration">
						</div>
						<div class="slide-content">
							<div class="slide-decorations">
								<img class="deco-goctren"
									src="<?php echo get_template_directory_uri(); ?>/img/goctren.svg" alt="Decor">
								<img class="deco-gocduoi"
									src="<?php echo get_template_directory_uri(); ?>/img/gocduoi.svg" alt="Decor">
							</div>
							<div class="slide-inner">
								...
								<div class="slide-image" data-aos="fade-left">
									...
									<img class="lozad" data-src="<?php echo esc_url($rent_hero_img['url']); ?>"
										alt="<?php echo esc_attr($rent_hero_img['alt'] ?: 'Product'); ?>" />
									<?php else : ?>
									<img class="lozad"
										data-src="<?php echo get_template_directory_uri(); ?>/img/product-banner.png"
										alt="Product" />
									<?php endif; ?>
								</div>
							</div>
						...
						<div class="slide-content">
							...
							<div class="slide-inner">
								<div class="slide-info" data-aos="fade-right">
									...
									<p class="slide-desc">Đối tác phân phối & dịch vụ máy photocopy, máy in chuyên
										nghiệp</p>
								</div>
								<div class="slide-image" data-aos="fade-left">
									<img class="lozad"
