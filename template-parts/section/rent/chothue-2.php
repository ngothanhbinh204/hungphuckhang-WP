...
$rent_show_partner = get_field('rent_show_partner'); // Checkbox: Show partner section
?>

<?php if ( $rent_show_partner ) : ?>
<section class="chothue-2">
	<div class="container">
		...
		<div class="partner-grid">
			...
			<div class="item-col <?php echo $hide_class; ?>">
				<div class="partner-item">
					<div class="partner-logo">
						<img src="<?php echo esc_url($partner['url']); ?>"
							alt="<?php echo esc_attr($partner['alt'] ?: 'Partner'); ?>">
					</div>
				</div>
			...
			<div class="item-col">
				<div class="partner-item">
					<div class="partner-logo"><img src="<?php echo get_template_directory_uri(); ?>/img/logo_doitac.png"
							alt="Partner"></div>
				</div>
				<div class="hover-line"></div>
			</div>
		...
		<div class="btn-view-more-wrap">
			<a class="btn-view-more btn btn-primary btn-primary-hover" id="btn-load-more-partners"
